...
CLICKUP_CUSTOM_FIELDS = {
    ...
    "whatsapp": "9c5b9ad9-b085-4fdd-a0a9-0110d341de7c",  # Campo WhatsApp
    "valor": "ae3dc146-154c-4287-b2aa-17e4f643cbf8"  # Campo Oportunidade (valor)
}
...
def get_custom_fields(email: str, whatsapp: str, valor: int) -> Dict[str, Dict[str, str]]:
    """
    ...
    return {
        ...
        CLICKUP_CUSTOM_FIELDS["whatsapp"]: {"value": whatsapp},
